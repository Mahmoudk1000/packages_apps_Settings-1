...
public class ElegantVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "ElegantVersionDialogCtrl";
    ...
    public ElegantVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
